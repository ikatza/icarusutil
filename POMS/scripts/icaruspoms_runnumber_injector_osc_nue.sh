...
#for osc nue
echo "physics.producers.generator.TopVolume:  \"volCryostat\"" >> $FCL
echo "physics.producers.generator.MixerConfig: \"map 14:12 -14:-12 12:14 -12:-14\"" >> $FCL
echo "physics.producers.generator.GenFlavors: [ 14, -14 ]" >> $FCL
echo "physics.producers.generator.FluxCopyMethod: \"IFDH\"" >> $FCL
