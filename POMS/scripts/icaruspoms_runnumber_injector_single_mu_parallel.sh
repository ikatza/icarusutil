...
#for single_mu_parallel_to_the_beam
echo "outputs.out1.fileName : \"prod_mu_parallel_workshop_icarus_%tc_gen.root\" " >> $FCL
echo "physics.producers.generator.PDG: [13]" >> $FCL
echo "physics.producers.generator.P0: [3]" >> $FCL
echo "physics.producers.generator.X0: [240.0]" >> $FCL
echo "physics.producers.generator.Y0: [0.0]" >> $FCL
echo "physics.producers.generator.Z0: [-40.0]" >> $FCL
echo "physics.producers.generator.PosDist: 0" >> $FCL
echo "physics.producers.generator.Theta0XZ: [0]" >> $FCL
echo "physics.producers.generator.Theta0YZ: [0]" >> $FCL
echo "physics.producers.generator.SigmaThetaXZ: [0]" >> $FCL
echo "physics.producers.generator.SigmaThetaYZ: [0]" >> $FCL
echo "physics.producers.generator.ParticleSelectionMode: 1" >> $FCL
